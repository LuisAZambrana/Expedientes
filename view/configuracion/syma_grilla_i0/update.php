<?php
     ...
     $obj = new db();
     $el_row = $obj->fcGetSQL("SELECT 'm' as abm, syma_grilla_i0.* FROM syma_grilla_i0 WHERE itemid =".$_POST['itemid'],1,2);
     $el_row["abm"]="m";
     ...
     $prueba_1= $obj ->ConfiguracionProcedimientoAlmacenado("syma_grilla_i0",1,$el_row);
     if ($prueba_1 > 0) {header("Location:index.php?id=".  $obj->codificar_valor($_POST["grillaid"],1));
