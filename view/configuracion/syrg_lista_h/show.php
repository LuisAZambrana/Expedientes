<?php
    ...
    $ruta_raiz="/proyecto/";
    $ruta_i0 ="/proyecto/view/configuracion/syrg_lista_i0/";
    $rows = $obj->fcGetSQL("SELECT * FROM syrg_lista_h  where listaid=".$_GET['id'],1,2);
    if ($rows['listafija']== 1){
...
<?php
    ...
    echo($obj->configurar_grilla_personalizado(9," baja = 0 and listaid=".$_GET['id'], $control));
?>
</div>
</div>
<?php
