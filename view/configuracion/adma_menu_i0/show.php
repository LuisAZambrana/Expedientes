...
<div class="pb-3">
<a href="<? echo("index.php?id=".$date['menuid']) ?>" class="btn btn-primary"> Regresar </a>
<a href="edit.php?id=<?= $date['itemmenuid']?>" class="btn btn-success"> Actualizar </a>
      ...
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-footer">
                  ...
                  <a href="delete.php?id=<?= $date['itemmenuid']?>" type="button" class="btn btn-danger">Eliminar!</a>
                  </div>
        </div>
      </div>
  </div>
