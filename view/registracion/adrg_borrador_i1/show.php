<?php
    ...
    $obj= new db();
    $ruta="/proyecto/view/registracion/adrg_borrador_i1/";
...
<section id="destino" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Destino del Expediente</h2>
          <p>Cargar, editar o borrar el destino del expediente.</p>
        </div>
<div class="container" data-aos="fade-up">
...
echo($prueba->configurar_grilla_sin_control(24,"baja = 0 and borradorid = ".$_GET['id']));
?>
</div>
</div>
<?php
