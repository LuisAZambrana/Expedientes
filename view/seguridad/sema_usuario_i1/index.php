<?php
    ...
    $ruta_i0="/proyecto/view/seguridad/sema_usuario_i1/";
?>
<section id="sectorpersonas">
      <div class="container">
        <div class="section-title">
          <h2>Sectores de Usuarios</h2>
          <p>Cargar, editar y borrar Sectores de Usuarios</p>
        </div>
...
<div>
   <?php
        echo($obj->configurar_grilla_param_alta(21," baja = 0 and personaid = ".$_GET['id'],$ruta_i0,$obj->codificar_valor($_GET['id'],1)));
   ?>
</div>
