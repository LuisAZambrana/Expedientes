<?php
    ...
    $ruta_raiz="/proyecto/";
    $rows = $obj->fcGetSQL("SELECT * FROM sema_rol_h  where rolid =".$_GET['id'],1,2);
?>
<section id="menu" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Roles</h2>
          <p>Cargar, editar y borrar un Rol</p>
        </div>
<div class="container" data-aos="fade-up">
...
<?php
    ...
    echo($obj->configurar_grilla_sin_control(17," baja = 0 and rolid=".$_GET['id']));
