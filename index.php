...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Bienvenido <? echo $name ?></h1>
      <p><span class="typed" data-typed-items="Sistema de Expedientes Online, Municipio de Chimpay, #EsAhora"></span></p>
      <div class="social-links">
       <!-- <a href="#" class="twitter"><i class="bx bxl-twitter"></i></a>-->
        <a href="https://www.facebook.com/MunicipioChimpay" class="facebook"><i class="bx bxl-facebook"></i></a>
        <a href="https://www.instagram.com/municipiodechimpay/" class="instagram"><i class="bx bxl-instagram"></i></a>
        <a href="https://www.youtube.com/@MunicipiodeChimpay" class="google-plus"><i class="bx bxl-youtube"></i></a>
    ...
    </section><!-- End Opcion de Usuarios -->
